...
%ADVANCEDCOLORMAP  Performs advanced colormap operations
%
...
if nargin==1
    switch command
        case 'blue'; command='kb';
        case 'green'; command='kg';
        case 'red'; command='kr';
        case 'cyan'; command='kc';
        case 'magenta'; command='km';
        case 'yellow'; command='ky';
        case 'grey'; command='gray';
    end
end
